                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="connexion.php" class="dropdown-item">inscriptions</a>
                            <a href="../page_cnx/logout.php" class="dropdown-item">Déconnexion</a>
                        </div>
                    </div>
                </div>
            </nav>
...
$query= "SELECT * FROM inscriptiontfp";

$result= $db->query($query);
?>
<div class="container-fluid pt-4 px-4">
   <div class="bg-secondary text-center rounded p-4">
   <h6 class="mb-0">      TFP-APS   </h6> 
   <br/>
       <div class="d-flex align-items-center justify-content-between mb-4">
           ...
           <table class="table text-start align-middle table-bordered table-hover mb-0">
            ...
            <tr>
                ...
                <td><?= $produit['sean'] ?></td>
                <td>
                <a href="modification/update_tfp.php?u_id=<?php echo $produit['id']; ?>" class="btn btn-info" role="button">Update</a>
                   <a href="suprimer/delete.php?u_id=<?php echo $produit['id']; ?>" class="btn btn-danger" role="button">Delete</a>
                 </td>
...
$query= "SELECT * FROM inscriptionmac";

$result= $db->query($query);
?>
<div class="container-fluid pt-4 px-4">
   <div class="bg-secondary text-center rounded p-4">
   <h6 class="mb-0">      MAC APS   </h6>
   <br/>
       <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        foreach($result as $produi){
            ...
            <tr>
                ...
                <td><?= $produi['sean1'] ?></td>
                <td>
                   <a href="modification/update_mac.php?u_id=<?php echo $produi['id']; ?>" class="btn btn-info" role="button">Update</a>
                   <a href="suprimer/delete1.php?u_id=<?php echo $produi['id']; ?>" class="btn btn-danger" role="button">Delete</a>
