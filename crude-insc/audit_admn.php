       ...
       <div class="d-flex align-items-center justify-content-between mb-4">
           ...
           <table class="table text-start align-middle table-bordered table-hover mb-0">
            ...
            <tr>
                ...
                <td><?= $produitp['dtp'] ?></td>
                <td><?= $produitp['nomp'] ?></td>
                <td><?= $produitp['prenomp'] ?></td>
                <td><?= $produitp['villep'] ?></td>
                <td><?= $produitp['adrp'] ?></td>
                <td><?= $produitp['mailp'] ?></td>
                <td><?= $produitp['phonep'] ?></td>
                <td><?= $produitp['seanp'] ?></td>
                <td>
                <a href="modification/update_audit.php?u_id=<?php echo $produitp['id']; ?>" class="btn btn-info" role="button">Update</a>
                   <a href="suprimer/deletep.php?u_id=<?php echo $produitp['id']; ?>" class="btn btn-danger" role="button">Delete</a>
                 </td>
